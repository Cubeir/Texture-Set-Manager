...
public sealed partial class ReviewPromptControl : UserControl
{
    ...
    {
        await Windows.System.Launcher.LaunchUriAsync(new Uri("ms-windows-store://review/?ProductId=9P9HP6ZL1981"));
...
public static class ReviewPromptManager
{
    ...
    private const int SHOW_DELAY_SECONDS = 0; // delay to show it after being called
